...
public class ChessMach {
    ...
    private void validateSourcePosition(Position position) {
        if (!board.thereIsAPiece(position)) {
            throw new ChessException("There is no piece at the source position");
        }
        if (currentPlayer != ((ChessPiece)board.piece(position)).getColor()){
            throw new ChessException("the chosen piece is not yours");
        }
        if (!board.piece(position).isThereAnyPossiblrMove()){
    ...
    private Piece makeMove(Position source, Position target){
        ...
        if (capturedPice != null){
           ...
           capturdPieces.add(capturedPice);
        }
    ...
    private void undoMove(Position source, Position target, Piece capturedPiece){
        ...
        if (capturedPiece != null){
            ...
            capturdPieces.remove(capturedPiece);
    ...
    private ChessPiece king(Color color){
        ...
        throw new IllegalStateException("There is no " + color + "kind on the board");
    }
